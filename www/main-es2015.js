...
module.exports = __webpack_require__(/*! C:\Users\erico\mrdaniel\agriApp\src\main.ts */"zUnb");
...
/* harmony import */ var ngx_electron__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ngx-electron */ "31Lz");
/* harmony import */ var _capacitor_core__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! @capacitor/core */ "gcOT");
/* harmony import */ var _services_screensize_service__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./services/screensize.service */ "uIHg");
...
const { LocalNotifications, Clipboard, Modals } = _capacitor_core__WEBPACK_IMPORTED_MODULE_9__["Plugins"];
let AppComponent = class AppComponent {
    constructor(platform, splashScreen, statusBar, electronService, screensizeService) {
...
/* harmony import */ var ngx_electron__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ngx-electron */ "31Lz");
...
/* harmony import */ var _app_firebase_config__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! ./app.firebase.config */ "5CMf");
...
AppModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
        ...
        imports: [
            ...
            _angular_fire__WEBPACK_IMPORTED_MODULE_12__["AngularFireModule"].initializeApp(_app_firebase_config__WEBPACK_IMPORTED_MODULE_15__["FIREBASE_CONFIG"]),
...
const routes = [
    ...
    {
        path: "admin",
        loadChildren: () => __webpack_require__.e(/*! import() | pages-admin-admin-module */ "pages-admin-admin-module").then(__webpack_require__.bind(null, /*! ./pages/admin/admin.module */ "GCp2")).then((m) => m.AdminPageModule),
    },
    {
        path: "activities",
        loadChildren: () => __webpack_require__.e(/*! import() | pages-activities-activities-module */ "pages-activities-activities-module").then(__webpack_require__.bind(null, /*! ./pages/activities/activities.module */ "+rdI")).then((m) => m.ActivitiesPageModule),
    },
    {
        path: "equipement",
        loadChildren: () => __webpack_require__.e(/*! import() | pages-equipement-equipement-module */ "pages-equipement-equipement-module").then(__webpack_require__.bind(null, /*! ./pages/equipement/equipement.module */ "gilW")).then((m) => m.EquipementPageModule),
    },
    {
        path: "employee",
        loadChildren: () => Promise.all(/*! import() | pages-employee-employee-module */[__webpack_require__.e("common"), __webpack_require__.e("pages-employee-employee-module")]).then(__webpack_require__.bind(null, /*! ./pages/employee/employee.module */ "2FAO")).then((m) => m.EmployeePageModule),
    },
    {
        path: "inventory",
        loadChildren: () => __webpack_require__.e(/*! import() | pages-inventory-inventory-module */ "pages-inventory-inventory-module").then(__webpack_require__.bind(null, /*! ./pages/inventory/inventory.module */ "9JbG")).then((m) => m.InventoryPageModule),
    },
    {
        path: 'created-activitie',
        loadChildren: () => Promise.all(/*! import() | pages-created-activitie-created-activitie-module */[__webpack_require__.e("default~modal-add-activie-modal-add-activie-modal-module~pages-created-activitie-created-activitie-module"), __webpack_require__.e("common"), __webpack_require__.e("pages-created-activitie-created-activitie-module")]).then(__webpack_require__.bind(null, /*! ./pages/created-activitie/created-activitie.module */ "4/l1")).then(m => m.CreatedActivitiePageModule)
    },
    {
        path: 'instruction',
        loadChildren: () => Promise.all(/*! import() | modal-instruction-instruction-module */[__webpack_require__.e("common"), __webpack_require__.e("modal-instruction-instruction-module")]).then(__webpack_require__.bind(null, /*! ./modal/instruction/instruction.module */ "kpVe")).then(m => m.InstructionPageModule)
    },
    {
        path: 'add-activie-modal',
        loadChildren: () => Promise.all(/*! import() | modal-add-activie-modal-add-activie-modal-module */[__webpack_require__.e("default~modal-add-activie-modal-add-activie-modal-module~pages-created-activitie-created-activitie-module"), __webpack_require__.e("modal-add-activie-modal-add-activie-modal-module")]).then(__webpack_require__.bind(null, /*! ./modal/add-activie-modal/add-activie-modal.module */ "qkwY")).then(m => m.AddActivieModalPageModule)
    },
    {
        path: 'inscription',
        loadChildren: () => Promise.all(/*! import() | pages-inscription-inscription-module */[__webpack_require__.e("common"), __webpack_require__.e("pages-inscription-inscription-module")]).then(__webpack_require__.bind(null, /*! ./pages/inscription/inscription.module */ "4Smk")).then(m => m.InscriptionPageModule)
    },
];
