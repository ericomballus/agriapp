(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["pages-inscription-inscription-module"], {
    ...
    /***/
    function Smk(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      InscriptionPageModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
        imports: [_angular_common__WEBPACK_IMPORTED_MODULE_2__["CommonModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_3__["FormsModule"], _ionic_angular__WEBPACK_IMPORTED_MODULE_4__["IonicModule"], _inscription_routing_module__WEBPACK_IMPORTED_MODULE_5__["InscriptionPageRoutingModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_3__["ReactiveFormsModule"]],
    ...
    function hXF(module, __webpack_exports__, __webpack_require__) {
      ...
      var _raw_loader_inscription_page_html__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
      /*! raw-loader!./inscription.page.html */
      "xfQF");
      /* harmony import */


      var _inscription_page_scss__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
      ...
      var src_app_services_authentification_service__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(
      /*! src/app/services/authentification.service */
      "izgN");

      var InscriptionPage = /*#__PURE__*/function () {
        // tslint:disable-next-line:max-line-length
        function InscriptionPage(auth, toastController, formBuilder, router) {
        ...
        _createClass(InscriptionPage, [{
          ...
          key: "initInscriptionForm",
          value: function initInscriptionForm() {
          ...
          key: "onInscriptionFormSubmit",
          value: function onInscriptionFormSubmit() {
            var _this = this;

            console.log("inscription");
            var value = this.inscriptionForm.value;
            console.log(value);
            var login = value.login;
            var passe = value.passe;
            var confirmation = value.confirmation;

            if (passe === confirmation) {
              this.auth.inscription(login, passe).then(function () {
                _this.router.navigate(["profil"]);
              })["catch"](function (e) {
                if (e.code === "auth/email-already-in-use") {
                  _this.notifier("Cet email est déjà utilisé");
                } else {
                  _this.notifier("Une erreur est survenue");
                }
              });
            } else {
          ...
          key: "inscriptionGoogle",
          value: function inscriptionGoogle() {
      ...
      InscriptionPage = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_3__["Component"])({
    ...
    /***/
    function Gmid(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function qDPS(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function xfQF(module, __webpack_exports__, __webpack_require__) {
      "use strict";
...
//# sourceMappingURL=pages-inscription-inscription-module-es5.js.map