  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["pages-login-login-module"], {
    ...
    function bP1B(module, __webpack_exports__, __webpack_require__) {
      ...
      var LoginPage = /*#__PURE__*/function () {
        function LoginPage(router, auth, database, toastController, userservice) {
        ...
        _createClass(LoginPage, [{
          ...
          key: "login",
          value: function login(formadmin) {
            console.log(formadmin.value);
            var name = formadmin.value.password;
          ...
          value: function connexion(login, passe) {
            ...
            this.auth.connexion(login, passe).then(function (utilisateur) {
              //console.log(utilisateur);
              _this.email = login;

              _this.chercherUtilisateur();

              if (utilisateur) {// this.chercherUtilisateur(utilisateur);
              } else {
              ...
              _this.notifier("Login ou mot de passe incorrect");
            });
          }
        }, {
          key: "notifier",
          ...
          key: "chercherUtilisateur",
          value: function chercherUtilisateur() {
