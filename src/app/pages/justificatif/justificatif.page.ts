...
@Component({
  ...
  templateUrl: "./justificatif.page.html",
  styleUrls: ["./justificatif.page.scss"],
})
export class JustificatifPage implements OnInit {
  isSubmitted = false;
  errorControl: any;
  ...
  getJustificatif() {
    this.achatService.getJustificatif().subscribe(
      (data: Array<Materiel>) => {
        console.log(data);
